    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-teal-800 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5')}>
